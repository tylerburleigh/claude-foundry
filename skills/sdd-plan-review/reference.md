...
- [Core Workflow (Detailed)](#core-workflow-detailed)
- [Review Type Selection](#review-type-selection)
...
See [Priority Assignment](#priority-assignment) for consensus details.
